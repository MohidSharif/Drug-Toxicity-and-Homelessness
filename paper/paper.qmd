...
@fig-gender-graph suggests that males occupy a majority of the homeless population as well as being more prone to drug abuse. This observation explains why we see a much greater number of male deaths compared to females. However, this does not explain why the pandemic affected the male population more greatly than the female population, and why did the death count for the female population drop so drastically for the year 2023? Looking at the @fig-age-graph we can see that during 2023, the age group 20-39 saw a greatest dip pin death count. Coupling this with @fig-gender-graph could suggest that a large number of females from the ages 20-39 saw improvements in deaths due to drug toxicity.

Our results are summarized in @tbl-modelresults. We need a paragraph about this table. 
