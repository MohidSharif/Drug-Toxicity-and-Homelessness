...
Define $count_i$ as the count of deaths that resulted from drug toxicity in Toronto. Then $\beta_i$ is the wing width and $\gamma_i$ is the wing length, both measured in millimeters.  
