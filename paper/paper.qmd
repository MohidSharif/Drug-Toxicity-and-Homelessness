...
Thirdly, we expect changes within years as the death count increased during the pandemic seen in @age-graph. The years pre and post Covid-19 are extremely similar. There was a clear increase during the pandemic but not the topic of this paper, therefor not studied further.
...
This table is for negative binomial model
```{r}
#| echo: false
#| eval: true
